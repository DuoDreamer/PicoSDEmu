...
6. [x] Connect the Pico USB backend to the SD model using write-through behavior and
   ...
   - [x] Teach the SPI response worker to defer data tokens and write completion
